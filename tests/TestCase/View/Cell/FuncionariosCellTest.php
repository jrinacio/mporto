...
use App\View\Cell\FuncionariosCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\FuncionariosCell Test Case
 */
class FuncionariosCellTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \App\View\Cell\FuncionariosCell
     */
    public $Funcionarios;
    ...
    public function setUp()
    {
        ...
        $this->Funcionarios = new FuncionariosCell($this->request, $this->response);
    }
