...
use App\View\Cell\EquipeCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\EquipeCell Test Case
 */
class EquipeCellTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Equipe = new EquipeCell($this->request, $this->response);
    }
