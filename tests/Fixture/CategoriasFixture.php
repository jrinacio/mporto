...
class CategoriasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_usecat_idx' => ['type' => 'index', 'columns' => ['usuario_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_usecat' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'usuario_id' => 1,
            'ativo' => 1,
            'created' => '2016-05-31 20:04:55',
            'modified' => '2016-05-31 20:04:55'
        ],
    ];
}
