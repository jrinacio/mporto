 ...
 *
 */
class DetalhesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_ususet_idx' => ['type' => 'index', 'columns' => ['usuario_id'], 'length' => []],
            'fk_empdet_idx' => ['type' => 'index', 'columns' => ['empresa_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_empdet' => ['type' => 'foreign', 'columns' => ['empresa_id'], 'references' => ['empresas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'usuario_id' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'usuario_id' => 1,
            'created' => '2016-08-22 09:13:49',
            'modified' => '2016-08-22 09:13:49',
            'ativo' => 1
        ],
    ];
}
